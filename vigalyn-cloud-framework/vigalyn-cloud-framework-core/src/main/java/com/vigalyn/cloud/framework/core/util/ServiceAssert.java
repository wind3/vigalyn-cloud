package com.vigalyn.cloud.framework.core.util;
...
public class ServiceAssert {
     ...
     */
    public static void isTrue(boolean expression, ErrorCodeAndMsg errorCodeAndMsg) {
        if (!expression) {
            throw new ServiceException(errorCodeAndMsg);
        }
    }
     ...
     */
    public static void isNull(Object object,ErrorCodeAndMsg errorCodeAndMsg) {
        if (object != null) {
            throw new ServiceException(errorCodeAndMsg);
        }
    }
     ...
     */
    public static void notNull(Object object,ErrorCodeAndMsg errorCodeAndMsg) {
        if (object == null) {
            throw new ServiceException(errorCodeAndMsg);
        }
    }
     ...
     */
    public static void hasLength(String text,ErrorCodeAndMsg errorCodeAndMsg) {
     ...
     */
    public static void hasText(String text,ErrorCodeAndMsg errorCodeAndMsg) {
     ...
     */
    public static void doesNotContain(String textToSearch, String substring,ErrorCodeAndMsg errorCodeAndMsg) {
     ...
     */
    public static void notEmpty(Object[] array,ErrorCodeAndMsg errorCodeAndMsg) {
     ...
     */
    public static void noNullElements(Object[] array,ErrorCodeAndMsg errorCodeAndMsg) {
        if (array != null) {
     ...
     */
    public static void nmpty(Collection<?> collection, ErrorCodeAndMsg errorCodeAndMsg) {
     ...
     */
    public static void notEmpty(Map<?, ?> map, ErrorCodeAndMsg errorCodeAndMsg) {
     ...
     */
    public static void isInstanceOf(Class<?> type, Object obj,ErrorCodeAndMsg errorCodeAndMsg) {
        notNull(type, errorCodeAndMsg);
        if (!type.isInstance(obj)) {
            instanceCheckFailed(type, obj, errorCodeAndMsg.getMsg());
        }
    }
     ...
     */
    public static void isAssignable(Class<?> superType, Class<?> subType,ErrorCodeAndMsg errorCodeAndMsg) {
        notNull(superType, errorCodeAndMsg);
        if (subType == null || !superType.isAssignableFrom(subType)) {
            assignableCheckFailed(superType, subType,errorCodeAndMsg.getCode(), errorCodeAndMsg.getMsg());
        }
    }
